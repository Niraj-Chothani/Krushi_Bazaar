...
<head>
  ...
  <link rel="shortcut icon" href="images/Logo-1.png.png">
...
<body style="background-color:#E8ECEF">
        ...
        <div class="row ">
          ...
          <div class="col-md-6">
            <div class="terms">
              ...
              <li>You can also ask any question regarding our website and services.</li><br>
  ...
  <div class="container">
    ...
    <div class="modal fade" id="modal_ans" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="row">
      <div class="col-md-12 question">
        <div id="pending" style="display:none;">
          ...
          <?php
          $conn = new mysqli("localhost", "root", "", "krushi_bazaar");
          $sql = "SELECT * FROM qa";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              if (empty($row['answer'])) {
                echo ("<li>Question id = " . $row["id"] . "<br>  Question: " . $row["question"] . "</li><br>"
                );
              }
            }
          }
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            if (!empty($row['answer'])) {
              echo ("<li><b>" . $row["question"] . "</b></li><br>"
