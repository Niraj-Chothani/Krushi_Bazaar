...
if (isset($_POST['submit_btn'])) {
  ...
  else if($_POST['division']==1) $div = 'Gandhinagar';
  ...
  $sql = "INSERT INTO equipments (title,description,price,phone_number,location,division,availability)
        VALUES('$title', '$des', '$price', '$phone_number', '$location', '$divsn', '1')";
